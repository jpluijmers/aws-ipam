...
export const putHandler = async (
    ...
    try {
        ...
        subnet.SubnetId = context.getRequestParameter('subnetid');
        subnet.AvailabilityZone = context.getRequestParameter('availabilityzone');

        await SubnetsRepo.write(subnet);
